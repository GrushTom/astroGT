...
export const zh_CN: Translation = {
	...
	[Key.friends]: "友链",
	[Key.friendsDescription]: "如果您也想加入友链名单，请 <a href='https://github.com/GrushTom/astroGT' target='_blank' rel='noopener noreferrer' class='text-[var(--primary)] hover:underline'>点击这里提交</a>",
	[Key.guestbook]: "留言",
